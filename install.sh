#!/bin/bash
	...
	# -> -> VERY IMPORTANT!! <- <-
	# replace every thing within these brackets <path> with 
	# your absolute path i.e. <your-desktop-wallpaper-path> MUST BE
	# REPLACED WITH YOUR desktop wallpaper path
	# Note: you can jump directly to config section to make these replacements just type /Conf and press Return 
	
	# Note: don't forget to run this script with root access
	...
	exec_always --no-startup-id numlockx on \n\
	 \n\
	#set background \n\
	exec_always nitrogen --set-auto <your-desktop-wallpaper-path> \n\
	 \n\
